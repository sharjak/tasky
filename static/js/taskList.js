    ...
    !function () {
        ...
        Calendar.prototype.renderEvents = function (events, ele) {
            ...
            wrapper.appendChild(createElement('input', 'taskInput form-control', 'Create an event')).addEventListener('keypress', function (e) {
                ...
                var day = $(".selected .day-number")[0].textContent;
                var monthYear = $(".header")[0].firstChild.textContent;
                ...
                if (key === 13) { // 13 is enter
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            data.push({eventName: task, date: moment().date(day), calendar: 'Work', color: 'orange'});
                            var evSpan = createElement('span', 'orange');
                            $('.selected .day-events')[0].appendChild(evSpan);
                        }
                    })
                }
            })
